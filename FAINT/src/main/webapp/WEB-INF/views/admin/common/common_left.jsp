<%@page import="com.faint.domain.UserVO"%>
			...
			<div id="main-menu">
				<ul class="sidebar-nav">
					...
					<li><a href="#"><i class="glyph-icon flaticon-pages"></i><span class="sidebar-text">서비스 관리</span><span class="fa arrow"></span></a>
						<ul class="submenu collapse">
							<li><a href="${pageContext.request.contextPath}/admin/user"><span class="sidebar-text">회원 관리</span></a></li>
							<li><a href="${pageContext.request.contextPath}/admin/post"><span class="sidebar-text">게시물 관리</span></a></li>
							<li><a href="${pageContext.request.contextPath}/admin/reply"><span class="sidebar-text">댓글 관리</span></a></li>
							<li><a href="${pageContext.request.contextPath}/admin/report/user"><span class="sidebar-text">유저 신고</span></a></li>
							<li><a href="${pageContext.request.contextPath}/admin/report/post"><span class="sidebar-text">게시물 신고</span></a></li>
						</ul>
					</li>
