...
@media (min-width:414px){._cepxb{margin:0 auto}}
 ...
 <script>
	$(document).ready(function() {
		...
		//작성중 다른페이지 이동 시 확인처리
		$(".explore, .new-post, .recommend, .account, #logo, ._2g7d5, a._pg23k").on("click", function(event){
			unloadCheck();
		});
	}); //ready 끝
