            ...
            <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
                <div class="login-box clearfix animated flipInY">
                    <div class="page-icon animated bounceInDown">
                        <img src="${pageContext.request.contextPath}/resources/pixit/admin/assets/img/avatars/avatar12_big.png" alt="avatar 12" />
                    </div>
                    <div>
                    ...
                    <div class="login-form">
                        ...
                        <div class="login-links">
                            <a href="${pageContext.request.contextPath}/admin/login">Sign in using another account</a> 
                        </div>
                    </div>
                </div>
            </div>
